...
public class StartedKitApp {

    private static final Logger log = LoggerFactory.getLogger(StartedKitApp.class);

    private final Environment env;

    public StartedKitApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes startedKitApp.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(StartedKitApp.class);
